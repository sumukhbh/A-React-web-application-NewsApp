...
class Politics extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch("https://hw8-backend.azurewebsites.net/guardiansection?section=politics").then(response => response.json())
        .then(response => {
        ...
        fetch("https://hw8-backend.azurewebsites.net/NYtimessection?section=politics").then(response => response.json())
        .then(response => {
            const articles = response.result
            console.log(articles)
